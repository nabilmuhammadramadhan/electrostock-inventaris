<?php
// 1. Keamanan Sesi Login (Wajib ada agar nyambung dengan login.php)
session_start();
...
if ($aksi == 'hapus') {
    ...
    // Hapus file gambar terlebih dahulu sebelum menghapus data database
...
// Jika tombol "Simpan Kategori" diklik (Gabungan Logika Smart Redirect)
if (isset($_POST['simpan_kategori'])) {
    $nama_kategori = mysqli_real_escape_string($koneksi, $_POST['nama_kategori']);
    $asal = isset($_POST['asal']) ? $_POST['asal'] : ''; // Cek asal request
    
    mysqli_query($koneksi, "INSERT INTO kategori (nama_kategori) VALUES ('$nama_kategori')");
    
    // Jika dari form tambah barang, kembalikan ke form tambah. Jika tidak, ke halaman utama.
    if ($asal == 'form_tambah_barang') {
...
<head>
    ...
    <!-- Menambahkan Google Font agar seragam dengan index -->
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Poppins', sans-serif; background-color: #f4f7f6; margin: 0; padding: 20px; color: #333; }
        .container { max-width: 1000px; margin: 0 auto; background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
        .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #eee; padding-bottom: 15px; margin-bottom: 20px; }
        
        .btn { padding: 10px 15px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 500; border: none; cursor: pointer; color: white; transition: 0.3s;}
        ...
        .form-control { width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px; box-sizing: border-box; font-family: 'Poppins', sans-serif;}
...
<div class="container">
    ...
    <?php if ($aksi == 'tambah') { ?>
        <!-- ========================================== -->
        <!-- HALAMAN TAMBAH BARANG (Dengan Gambar) -->
        <!-- ========================================== -->
        <div class="header">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small style="display:block; margin-top:6px; color:#555;">
                    Kategori tidak ada? <a href="barang.php?aksi=tambah_kategori" style="color:#0984e3; font-weight:600;">➕ Tambah Kategori Baru</a>
                </small>
            </div>
            <div class="form-group">
    ...
    <?php } else if ($aksi == 'tambah_kategori') { ?>
        <!-- ========================================== -->
        <!-- HALAMAN TAMBAH KATEGORI (Rute Khusus) -->
        <!-- ========================================== -->
        <div class="header">
        ...
        <form action="barang.php" method="POST">
            <input type="hidden" name="asal" value="form_tambah_barang">
            <div class="form-group">
    ...
    <?php } else { ?>
        ...
        <div class="header">
            <div>
                <h2 style="margin: 0 0 5px 0;">📦 Kelola Data Barang</h2>
        ...
        <!-- Form Kategori Cepat (Inline) -->
        <div id="formKategori" style="display:none; background:#f9f9f9; padding:15px; border:1px solid #ddd; margin-bottom:15px; border-radius:6px;">
            <form action="" method="POST">
                <input type="hidden" name="asal" value="utama">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 1.1em; color:#0984e3;"><strong><?php echo $row['stok']; ?></strong></td>
                    <td>
