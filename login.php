...
if(isset($_POST['login'])){
    ...
    // Menangkap ID (NIK) bukan username
    $id = $_POST['id'];
    $password = $_POST['password'];

    // Mengubah query untuk mengecek berdasarkan ID
...
<!-- Diubah menjadi input tipe number untuk ID Karyawan -->
<input
type="number"
name="id"
placeholder="ID Karyawan (NIK)"
required>
